...
Все основные результаты работы и доработок приложены в виде скриншотов,на скриншотах видно
что Zabbix получил внешний адрес, а snapshot schedule создан и доступен через output.
...
![Yandex cloud](screenshots/screenshot13.png)
